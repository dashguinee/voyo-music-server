...
export const VIBES: Vibe[] = [
  {
    ...
    name: 'AFRO HEAT',
    icon: '🔥',
    lottie: 'https://assets9.lottiefiles.com/packages/lf20_x1gjdldd.json', // Fire animation
    color: '#f97316',
...
export const TRACKS: Track[] = [
  ...
  // MORE BANGERS - Dec 2025
  {
    ...
    album: 'Lungu Boy',
    trackId: 'VoNI0LYvGzg',
    coverUrl: getThumbnailUrl('VoNI0LYvGzg'),
    duration: 180,
    tags: ['afrobeats', 'amapiano', 'party'],
    mood: 'hype',
    region: 'NG',
  ...
  },
  {
    ...
    trackId: 'vbfVZ41hXms',
    coverUrl: getThumbnailUrl('vbfVZ41hXms'),
    duration: 198,
  ...
  },
  {
    ...
    album: 'Playboy',
    trackId: 'At_hwHZLV-A',
    coverUrl: getThumbnailUrl('At_hwHZLV-A'),
    duration: 195,
  ...
  },
  {
    ...
    album: 'Stubborn',
    trackId: 'Xf3hy5E5Gec',
    coverUrl: getThumbnailUrl('Xf3hy5E5Gec'),
    duration: 165,
  ...
  },
  {
    ...
    album: 'Eziokwu',
    trackId: 'D0-4RPhrkHA',
    coverUrl: getThumbnailUrl('D0-4RPhrkHA'),
    duration: 172,
    tags: ['afrobeats', 'street', 'hype'],
    mood: 'hype',
    region: 'NG',
  ...
  },
  {
    ...
    album: 'Mnike',
    trackId: '4rY5TT2N_T4',
    coverUrl: getThumbnailUrl('4rY5TT2N_T4'),
    duration: 245,
  ...
  },
  {
    ...
    album: '19 & Dangerous',
    trackId: 'IfqIwVoJ5eQ',
    coverUrl: getThumbnailUrl('IfqIwVoJ5eQ'),
    duration: 178,
  ...
  },
  {
    ...
    album: 'Soweto Baby',
    trackId: 'EgIuTY_f5I4',
    coverUrl: getThumbnailUrl('EgIuTY_f5I4'),
    duration: 285,
  ...
  },
  {
    ...
    album: 'Mr Money With The Vibe',
    trackId: '4C0kKzZnYMU',
    coverUrl: getThumbnailUrl('4C0kKzZnYMU'),
    duration: 186,
    tags: ['afrobeats', 'amapiano', 'party'],
    mood: 'hype',
    region: 'NG',
  ...
  },
  {
    ...
    album: 'Twice As Tall',
    trackId: 'rCHr3-HMvJU',
    coverUrl: getThumbnailUrl('rCHr3-HMvJU'),
    duration: 234,
  ...
  },
  {
    ...
    album: 'Made In Lagos',
    trackId: 'hfm8tPuHNNQ',
    coverUrl: getThumbnailUrl('hfm8tPuHNNQ'),
    duration: 208,
    tags: ['afrobeats', 'rnb', 'chill'],
    mood: 'chill',
    region: 'NG',
  ...
  },
  {
    id: '24',
    title: 'KOLO',
    artist: 'Victony ft. Savage',
    album: 'Apollo',
    trackId: 'PpJTV3ca8mY',
    coverUrl: getThumbnailUrl('PpJTV3ca8mY'),
    duration: 188,
  ...
  },
  {
    ...
    album: 'Water & Garri',
    trackId: 'IWwmLLbktFM',
    coverUrl: getThumbnailUrl('IWwmLLbktFM'),
    duration: 195,
    tags: ['afrobeats', 'rnb', 'chill'],
    mood: 'rnb',
    region: 'NG',
